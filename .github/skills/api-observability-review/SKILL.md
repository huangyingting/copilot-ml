...
2. **Inspect relevant files.** Prefer `app/`, `tests/`, `infra/bicep/`, `.github/workflows/`, `specs/`, and the consolidated runbook section in `docs/05-customize-agents-skills-mcp.md`.
