...
| Draft a spec for a synthetic dependency-health summary | Module 4 / Lab 3 | Reviewed spec, no implementation yet |
| Review deployment workflow after OIDC setup | Module 5 or 6 / Lab 4a or 5 | PR-ready review comment |
| Apply observability review checklist to v1 | Module 6 / Lab 6 | Findings table and follow-up issue body |
